...
const MenuItemCard: React.FC<MenuItemCardProps> = ({ item, index = 0 }) => {
    ...
    const handleAddToCart = (e: React.MouseEvent) => {
        ...
        addToCart(item);
        setAddBurst(true);
        setTimeout(() => setAddBurst(false), 1400);
    };
                ...
                >
                    ...
                    <div style={{ position: 'relative', height: '200px', overflow: 'hidden', flexShrink: 0 }}>
                        ...
                        <div style={{
                            ...
                            background: 'white', borderRadius: '0.375rem', padding: '0.2rem',
                        ...
                        {inCart && (
                            <div style={{
                                ...
                                <ShoppingBasket size={9} strokeWidth={3} />
                    ...
                    <div style={{ padding: '0.875rem 1rem', flex: 1, display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem' }}>
                            <h4 style={{
                                fontSize: '1rem', fontWeight: 700, lineHeight: 1.25, flex: 1,
                                overflow: 'hidden', display: '-webkit-box',
                                WebkitLineClamp: 2, WebkitBoxOrient: 'vertical',
                            }}>{item.name}</h4>
                            <span style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--color-solidOne)', whiteSpace: 'nowrap' }}>
                                ₹{item.price.toFixed(0)}
                            </span>
                        </div>

                        <span style={{ fontSize: '0.72rem', fontWeight: 600, color: 'var(--color-gray-400)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                            {categoryName}
                        </span>

                        <p style={{
                            fontSize: '0.8125rem', color: 'var(--color-gray-500)', lineHeight: 1.45, flex: 1,
                            overflow: 'hidden', display: '-webkit-box',
                            WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', margin: '0.125rem 0',
                        }}>{item.description}</p>
                        ...
                        <div style={{
                            ...
                            marginTop: '0.5rem', paddingTop: '0.625rem', borderTop: '1px solid rgba(0,0,0,0.05)',
                        }}>
                            <span style={{
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    transform: addBurst ? 'scale(0.96)' : 'scale(1)',
                                    boxShadow: addBurst || !item.available ? 'none' : '0 2px 8px rgba(220,88,62,0.35)',
                                    whiteSpace: 'nowrap',
                                }}
                            >
